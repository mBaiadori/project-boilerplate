              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className="material-symbols-outlined"
                      style={{ fontSize: "15px", color: meta.color }}
                    >
                      {meta.icon}
                    </span>
        ...
        >
          {isEditing ? (
              ...
              >
                ...
                >
                  <span
                    ...
                    style={{
                      background:
                        CATEGORY_META[activeEntry.category]?.color || "#2563eb",
                      color: "#fff",
                      fontSize: "11px",
                      padding: "3px 8px",
                      borderRadius: "4px",
            ...
            >
              ...
              >
                Esta base armazena o conhecimento vivo de arquitetura,
                invariantes e ADRs sincronizadas diretamente no Git sob{" "}
                <code>.spec-memory/</code>.
              </p>
