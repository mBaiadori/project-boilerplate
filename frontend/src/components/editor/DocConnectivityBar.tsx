...
export const DocConnectivityBar: React.FC<DocConnectivityBarProps> = ({ filePath, onNavigateFile }) => {
  ...
  const layer = contextData?.layer || 'L4_ARTIFACT';
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: 'var(--color-outline)' }}>
            ...
            <React.Fragment key={idx}>
              ...
              <span
                style={{
                  ...
                  color: idx === segments.length - 1 ? 'var(--color-on-surface)' : 'var(--color-outline)'
                }}
              >
                {seg}
              </span>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            <span className="material-symbols-outlined icon-xs">call_received</span>
          ...
          {showConsumers && (
            ...
            >
              <strong style={{ fontSize: '11px', display: 'block', marginBottom: '4px' }}>Documentos Dependentes:</strong>
              {consumers.length === 0 ? (
                <span style={{ fontSize: '11px', color: 'var(--color-outline)' }}>Nenhum documento depende deste.</span>
              ) : (
                consumers.map((c: any, i: number) => (
                  <div
                    ...
                    style={{ padding: '4px 6px', cursor: 'pointer', borderRadius: '4px', fontSize: '11px' }}
        ...
        <div style={{ position: 'relative' }}>
          ...
          {showDeps && (
            ...
            >
              <strong style={{ fontSize: '11px', display: 'block', marginBottom: '4px' }}>Contratos Requeridos:</strong>
              {dependencies.length === 0 ? (
                <span style={{ fontSize: '11px', color: 'var(--color-outline)' }}>Nenhuma dependência direta.</span>
              ) : (
