...
export const GitModal: React.FC<GitModalProps> = ({
  ...
  const fetchFileDiff = useCallback(
    async (filePath: string) => {
      ...
      try {
        ...
        console.error(
          `[GitModal] Erro ao buscar comparativo de ${filePath}:`,
          err,
        );
      } finally {
  ...
  const handleMarkAsSeen = () => {
    ...
    setFeedback({
      type: "success",
      message: "Todas as novidades foram marcadas como visualizadas!",
    });
  };
  ...
  const handleCreateBranch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.success) {
        ...
        setFeedback({
          type: "error",
          message: res?.message || "Erro ao alternar trilha",
        });
      }
    } catch (err: any) {
      setFeedback({
        type: "error",
        message: err.message || "Erro ao alternar trilha de trabalho.",
      });
    }
  };
  ...
  const getFileDiffInfo = (filePath: string) => {
    ...
    const diffText =
      wsChange?.diff_text || wsChange?.diff || fileDiffs[filePath] || "";
  ...
  const allAreExpanded =
    ...
    changedFiles.every((f) => expandedFiles[f?.path]);
      ...
      >
        ...
        >
          <div>
            ...
            >
              Documentação: <strong>{activeRepo?.name || "Local"}</strong>{" "}
              {gitStatus?.remoteUrl
                ? `(${gitStatus.remoteUrl})`
                : "(Armazenamento Local)"}
            </span>
            ...
            style={{
              ...
              background:
                activeTab === "whats-new"
                  ...
                  : "transparent",
              color:
                activeTab === "whats-new" ? "#16a34a" : "var(--text-muted)",
              fontWeight: 600,
              fontSize: "13px",
              cursor: "pointer",
              display: "flex",
        ...
        <div
          ...
          style={{ overflowY: "auto", flex: 1, padding: "20px", gap: "16px" }}
        >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {isClean
                      ...
                      : `${changedFiles.length} documento(s) com rascunhos pendentes`}
                  </span>
                  {gitStatus?.ahead ? (
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button
                    ...
                    onClick={handleSync}
                    disabled={isSyncing}
                    title="Sincronizar com  (baixar novidades e enviar contribuições)"
                  >
                    <span className="material-symbols-outlined icon-xs">
                      cloud_sync
                    </span>
              ...
              >
                ...
                {changedFiles.length === 0 ? (
                  ...
                  >
                    ...
                    Nenhum rascunho pendente no momento. Todos os seus
                    documentos estão consolidados.
                  </div>
                ) : (
                    ...
                    {changedFiles.map((file, idx) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            borderBottom:
                              "1px solid var(--border-color-subtle, #f1f5f9)",
              ...
              >
                ...
                >
                  ...
                  Salvar Marco de Versão Oficial na Trilha{" "}
            ...
            >
              ...
              >
                ...
                >
                  <button
                    ...
                    onClick={handleSync}
                    disabled={isSyncing}
                    title="Buscar e baixar as últimas novidades d"
                  >
                    <span className="material-symbols-outlined icon-xs">
                      cloud_sync
                    </span>
              ...
              {whatsNewFilter !== "proposals" && (
                ...
                >
                  ...
                  >
                    <span style={{ fontWeight: 600, fontSize: "13px" }}>
                      Documentos Recebidos d ({filteredWhatsNewFiles.length})
                    </span>
                  </div>
          ...
          {activeTab === "history" && (
            ...
            >
              {(gitLog || []).length === 0 ? (
                ...
                >
                  Nenhum marco de publicação registrado no histórico desta
                  trilha.
                </div>
              ) : (
                (gitLog || []).map((commit, idx) => (
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        Publicado por{" "}
                        <strong>{commit?.author || "Equipe"}</strong> em{" "}
                        {commit?.date || ""}
                      </div>
                    </div>
                    <span
                      className="material-symbols-outlined"
                      style={{ color: "var(--text-dim)", fontSize: "18px" }}
                    >
                      history_edu
                    </span>
                  </div>
          ...
          {activeTab === "branches" && (
            ...
            >
              ...
              >
                ...
                >
                  Criar ou Alternar Trilha de Trabalho
                </h4>
                <div style={{ display: "flex", gap: "8px" }}>
                  <input
                    type="text"
