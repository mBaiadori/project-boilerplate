...
export const PromptSidebar: React.FC<PromptSidebarProps> = ({
  ...
  return (
    ...
    >
      <div className="ai-prompt-sidebar-header" style={{ padding: '12px 14px', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
            ...
            <span style={{ fontSize: '11px', color: 'var(--text-muted, #64748b)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              Context OS &bull; <span className="ai-copilot-prompt-agent-tag">Antigravity Agent</span>
            </span>
          </div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
          <button className="btn-icon ai-copilot-close-prompt-sidebar-btn" type="button" title="Fechar painel de parâmetros" onClick={onClose}>
      ...
      <div className="ai-prompt-sidebar-body" style={{ padding: '14px', display: 'flex', flexDirection: 'column', gap: '12px', flex: '1 1 auto', minHeight: 0, overflow: 'hidden', background: '#ffffff' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: '1 1 auto', minHeight: 0, gap: '6px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
            <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-heading)', marginBottom: 0 }}>
          ...
          <p className="ai-copilot-prompt-hint" style={{ fontSize: '11px', color: 'var(--text-muted)', margin: 0, lineHeight: 1.4, flexShrink: 0 }}>
          ...
          <textarea
            ...
            style={{ width: '100%', flex: '1 1 auto', minHeight: 0, height: '100%', padding: '12px', border: '1px solid var(--border-color, #cbd5e1)', borderRadius: '8px', fontSize: '12px', lineHeight: 1.5, fontFamily: 'var(--font-mono, monospace)', resize: 'none', boxSizing: 'border-box', background: '#f8fafc', outline: 'none' }}
            spellCheck="false"
            value={editedPrompt}
      ...
      <div className="ai-prompt-sidebar-footer" style={{ padding: '10px 14px', borderTop: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--bg-hover)' }}>
        <button
          className="ai-copilot-restore-btn btn-link-subtle"
          type="button"
          style={{ fontSize: '11.5px', background: 'none', border: 'none', color: 'var(--primary)', cursor: 'pointer' }}
